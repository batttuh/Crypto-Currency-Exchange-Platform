 ...
 * @author PC
 */
public class UIAgreement extends javax.swing.JFrame {

    /**
     * Creates new form UIAgreement
     */
    public UIAgreement() {
        initComponents();
        jTextPane1.setEditable(false);
        jTextPane1.setText("MOBILE APPLICATION DEVELOPMENT AND INTELLECTUAL PROPERTY ASSIGNMENT AGREEMENT\n" +
"\n" +
"\n" +
"\n" +
...
"\n" +
"\n" +
"6.2 Assignment. Developer hereby assigns to Company, its successors and assigns, all rights, title and Intellectual Property Rights interests in and to the Work including, without limitation, the following:\n" +
"\n" +
...
"\n" +
"\n" +
"12.2 Termination of Agreement. This Agreement will terminate upon ninety (90) days’ prior written notice by either party, provided that Developer must complete and deliver to Company all Work pursuant to any Schedules in effect.\n" +
"\n" +
...
"\n" +
"\n" +
"14.2 Withholding. If taxes are required to be withheld on any amounts otherwise to be paid by Company to Developer, Company may deduct such taxes from the amount otherwise owed and pay them to the appropriate taxing authority. At Developer’s written request and expense, Company will use reasonable efforts to cooperate with and assist Developer in obtaining tax certificates or other appropriate documentation, evidencing such payment, provided, however, that the responsibility for such documentation will remain with Developer.\n" +
"\n" +
...
"\n" +
"\n" +
"15.4 Governing Law and Forum. This Agreement will be construed and controlled by the laws of the State of New York, United States of America, without reference to the conflicts of law provisions thereof. All disputes arising out of this Agreement will be subject to the exclusive jurisdiction of either the state or federal courts located in New York, New York, United States of America.  \n" +
"\n" +
...
"IN WITNESS WHEREOF, intending to be legally bound by the terms of this Agreement, have caused this Agreement to be executed by their duly authorized representatives as of the Effective Date.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIAgreement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UIAgreement().setVisible(true);
